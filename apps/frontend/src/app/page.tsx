...
export default function LandingPage() {
  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden bg-transparent py-6 md:py-8">
            ...
            <div className="grid items-center gap-5 px-4 py-4 sm:px-6 sm:py-5 lg:grid-cols-[1fr_auto] lg:px-7">
              <div className="flex min-w-0 items-center gap-4">
                ...
                <div className="min-w-0">
                  <span className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-white px-3 py-1.5 text-[10px] font-black uppercase tracking-[0.24em] text-sky-700">
